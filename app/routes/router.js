...
var exportedRoutes = function (app) {
    ...
    routes.use('/api/activity/:id', secureRoutes);
    ...
    routes.use('/api/categories/', secureRoutes);
    routes.route('/api/categories/')
        .get(categoryController.get)
        .post(categoryController.post);

    routes.use('/api/category/:id', secureRoutes);
    routes.route('/api/category/:id', secureRoutes)
        .get(categoryController.find)
        // TODO edit
        .delete(categoryController.delete);

    var subCategoryController = require('./../controllers/sub-categories-controller');
    routes.use('/api/subcategories/', secureRoutes);
    routes.route('/api/subcategories/')
        .get(subCategoryController.get)
        .post(subCategoryController.post);

    routes.use('/api/subcategory/:id', secureRoutes);
    routes.route('/api/subcategory/:id', secureRoutes)
    ...
    routes.use('/api/indfield', secureRoutes);
    routes.route('/api/indfield')
        .post(indFieldController.post);

    routes.use('/api/indfield/:id', secureRoutes);
    routes.route('/api/indfield/:id', secureRoutes)
    ...
    routes.use('/api/actfield', secureRoutes);
    routes.route('/api/actfield')
        .post(activityFieldController.post);
    routes.use('/api/actfield/:id', secureRoutes);
    ...
    routes.use('/api/level', secureRoutes);
    routes.route('/api/level')
        .post(experienceLevelController.post) // create
    routes.use('/api/level/:id', secureRoutes);
    ...
    // approval
    routes.use('/api/approval/:id', secureRoutes);
